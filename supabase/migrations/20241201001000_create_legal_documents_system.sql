...
## 第1条（適用）
本規約は、ShutterHub v2（以下「本サービス」）の利用条件を定めるものです。
...
(
  'privacy_policy',
  '1.0', 
  'ShutterHub v2 プライバシーポリシー',
  '# ShutterHub v2 プライバシーポリシー

## 1. 基本方針
ShutterHub v2（以下「当社」）は、ユーザーの個人情報の重要性を認識し、個人情報の保護に関する法律等の関係法令等を遵守し、お客様の個人情報を適切に取り扱います。
