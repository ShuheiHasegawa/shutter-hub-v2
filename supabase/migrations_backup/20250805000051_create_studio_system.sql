-- Migration: 20250127000001_create_studio_system
...
CREATE TABLE studios (
  ...
  CONSTRAINT unique_location_hash 
    UNIQUE (location_hash) DEFERRABLE,
...
-- サンプルスタジオ（開発・テスト用）
INSERT INTO studios (
  name, description, address, prefecture, city, access_info,
  latitude, longitude, max_capacity, parking_available, wifi_available,
  business_hours, regular_holidays, hourly_rate_min, hourly_rate_max,
  created_by
) VALUES (
  'サンプルスタジオ東京',
  '撮影に最適な自然光スタジオです。白を基調とした清潔感のある空間で、ポートレートから商品撮影まで幅広く対応可能です。',
  '東京都渋谷区渋谷1-1-1',
  '東京都',
  '渋谷区',
  'JR渋谷駅から徒歩5分。ハチ公口を出て道玄坂方面へ。',
  35.6598, 139.7006, 15, true, true,
  '{"mon": "9:00-21:00", "tue": "9:00-21:00", "wed": "9:00-21:00", "thu": "9:00-21:00", "fri": "9:00-21:00", "sat": "9:00-21:00", "sun": "10:00-20:00"}',
  ARRAY['年末年始'],
  5000, 8000,
  (SELECT id FROM auth.users LIMIT 1) -- 実際の実装では適切なユーザーIDを設定
